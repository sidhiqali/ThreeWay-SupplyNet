  ...
  return (
    <div className='flex h-screen items-center justify-center p-5 bg-main bg-cover bg-no-repeat w-full'>
      <div className='text-center'>
        ...
        <h1 className='mt-5 text-[36px] font-bold text-slate-100 lg:text-[50px]'>
          404 - Page not found
        </h1>
        ...
        <Link to='/'>
          <button className='text-slate-300 my-3 h-12 w-36 hover:bg-yellow-600 hover:text-slate-900  bg-yellow-800 rounded-lg'>
            Go To Home Page
          </button>
        </Link>
      </div>
